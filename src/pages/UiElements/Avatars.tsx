...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title=" Avatars Dashboard | abitrack -  Admin Dashboard Template"
        description="This is  Avatars Dashboard page for abitrack -  Tailwind CSS Admin Dashboard Template"
      />
